# Business Model: Other Construction Installation
...
## Classification
- Repository: `cloud-itonami-isic-4329` ([github.com/cloud-itonami/cloud-itonami-isic-4329](https://github.com/cloud-itonami/cloud-itonami-isic-4329))
- ISIC Rev.5: `4329` — Other Construction Installation
- Domain: `:construction/other-installation`
...
## Customer
An operator running this vertical as an OSS business — :construction/other-installation — who wants
...
One managed tenant (:construction/other-installation):
