# Operator Quickstart — Other Construction Installation

Shortest path from clone to a verified local dry-run for **ISIC 4329** (`cloud-itonami-isic-4329`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-4329.git
cd cloud-itonami-isic-4329
```
