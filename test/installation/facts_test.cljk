...
(deftest usa-cites-real-osha-asbestos-and-fall-protection-law
  (let [sb (facts/spec-basis "USA")]
    (is (re-find #"1926\.1101" (:hazmat-survey-basis sb)))
    (is (re-find #"osha\.gov" (:hazmat-survey-provenance sb)))
