...
`cloud-itonami-4329` is an OSS open-business blueprint for other-
construction-installation-project operations coordination --
coordination-only, never trade-equipment control.

## Maintainers

Maintainers may merge changes that preserve these invariants:
- this actor never holds trade-equipment-control authority.
- this actor never holds installation-completion-sign-off authority --
...
- attempting to extend this actor's authority into trade-equipment
  control or installation-completion sign-off
